  ...
  <section class="content">
    <div class="box">
      <div class="box-header with-border">
        ...
        <a href="<?php echo base_url().'procurementMis'; ?>" alt="Procurement MIS" class="fa fa-arrow-left" style="float: right;" data-toggle="tooltip" data-placement="left" title="Procurement MIS"></a>                    
      </div>
      <div class="box-body">
        <div class="col-md-12">
          <fieldset>

        ...
        <section class="content">          
          <div class="box box-default"> 
            <div class="box-header with-border">
              <h3 class="box-title">Add Inventory Report</h3>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="date" id="date" class="form-control" autocomplete="off" required>
                      </div> 
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">                      
                      <div class="form-group">
                        ...
                        <input type="number" name="opening_stock" id="opening_stock" class="form-control" autocomplete="off" required>
                      </div>
                      <div class="form-group">
                        <label>Opening Stock Value</label><span>*</span>
                        <input type="text" name="opening_stock_value" id="opening_stock_value" class="form-control" readonly>
                      </div>        
                      <div class="form-group">
                        <label>Value Difference</label><span>*</span>
                        <input type="text" name="difference" id="difference" class="form-control" readonly>
                      </div>         
                    </div><!-- /.col -->
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Closing Stock</label><span>*</span>
                        <input type="number" name="closing_stock" id="closing_stock" class="form-control" autocomplete="off" required>
                      </div>
                      <div class="form-group">
                        <label>Closing Stock Value</label><span>*</span>
                        <input type="text" name="closing_stock_value" id="closing_stock_value" class="form-control" readonly>
                      </div>   
                    </div><!-- /.col -->
                  </div><!-- /.row -->
                </fieldset>     

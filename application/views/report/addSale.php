        ...
        <section class="content">          
          <div class="box box-default"> 
            <div class="box-header with-border">
              <h3 class="box-title">Add Sale Report</h3>
                  ...
                  <div class="row">
                    <div class="col-md-6">  
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="item_serial" id="item_serial" class="form-control" required>
                      </div> 
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tax_amount" id="tax_amount" class="form-control" autocomplete="off" required>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">                      
                      <div class="form-group">
                        ...
                        <input type="text" name="quote_no" id="quote_no" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Quotation Date</label><span>*</span>
                        <input type="text" name="quote_date" id="quote_date" class="form-control" autocomplete="off" required>
                      </div>   
                      <div class="form-group">
                        <label>Sales Order Number</label><span>*</span>
                        <input type="text" name="sales_order" id="sales_order" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Sales Date</label><span>*</span>
                        <input type="text" name="sales_date" id="sales_date" class="form-control" autocomplete="off" required>
                      </div>   
                      <div class="form-group">
                        <label>Sales Person</label><span>*</span>
                        <input type="text" name="sales_person" id="sales_person" class="form-control" required>
                      </div>                 
                    </div><!-- /.col -->
                    <div class="col-md-6">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="remain_amount" id="remain_amount" class="form-control" readonly>
                      </div>           
                    </div><!-- /.col -->
                  </div><!-- /.row -->
                </fieldset>     

            ...
            <div class="row">
              <div class="col-md-6">                    
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="hsn" id="hsn" class="form-control" readonly>
                </div>   
                <div class="form-group">
                  <label>Storage Location</label><span>*</span>
                  <input type="text" name="storage" id="storage" class="form-control" readonly>
                </div>
              </div><!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  <label>Ordered Quantity</label><span>*</span>
                  <input type="text" name="ordered_qty" id="ordered_qty" class="form-control" readonly>
                </div>
                <div class="form-group">
                  <label>Received Quantity</label><span>*</span>
                  <input type="text" name="received_qty" id="received_qty" class="form-control" required autocomplete="off">
                </div>
                <div class="form-group">
                  <label>Remaining Quantity</label><span>*</span>
                  <input type="text" name="remain_qty" id="remain_qty" class="form-control" readonly>
                </div>
                <div class="form-group">
                  <label>Challan No</label><span>*</span>
                  <input type="text" name="challan_no" id="challan_no" class="form-control" required>
                </div>                       
                <div class="form-group">
                  <label>Challan Date</label><span>*</span>
                  <input type="text" name="challan_date" id="challan_date" class="form-control" value="<?php echo date("Y-m-d"); ?>" readonly>
                </div>                   
                <div class="form-group">
                  <label>Challan Time</label><span>*</span>
                  <input type="text" name="challan_time" id="challan_time" class="form-control" value="<?php echo date("H:i A"); ?>" readonly>
                </div> 
                <div class="form-group">
